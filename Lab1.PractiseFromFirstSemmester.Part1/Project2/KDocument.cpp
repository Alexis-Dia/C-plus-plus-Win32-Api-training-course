...
//		return FALSE;
//	}
//	// Ïðî÷èòàòü ôàéë, ñîõðàíèâ èíôîðìàöèþ â âåêòîðå ñòðîê lines
//	while (!finp.eof()) {
//		finp.getline(buf, 199);
//		buf[199] = 0;
//		lines.push_back(string(buf));
//	}
//	// Âû÷èñëèòü ìàêñèìàëüíóþ äëèíó ñòðîêè
//	lineLenMax = 0;
//	for (int i = 0; i < lines.size(); ++i) {
//		int lineLen = lines[i].size();
//		// Êîððåêòèðîâêà, åñëè ñòðîêà ñîäåðæèò ñèìâîëû òàáóëÿöèè
//		int iTabPos = 0;
//		while (1) {
...
//	// îãðàíè÷åíèå íà ïîëîæèòåëüíîå ïðèðàùåíèå
//	yInc = min(yInc, vertRange - (int)vsi.nPage - vsi.nPos);
//	// îãðàíè÷åíèå íà îòðèöàòåëüíîå ïðèðàùåíèå
